## Warning!
This is a fork of Vundle with awesome git tree-ish objects support, written by [Xerkus](https://github.com/Xerkus/vundle/tree/feature/refactor-git-treeish-support). Unfortunately he doesnt update it anymore, so i've forked it and synced to the latest version.
